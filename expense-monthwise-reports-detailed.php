...
$cnt=$cnt+1;
 ...
 <tr>
  <th colspan="2" style="text-align:center">GTotal</th>     
  <td><?php echo $monthlyexpense;?></td>
 </tr>    
    </table>
...
//Monthly Expense
$userid=$_SESSION['detsuid'];
 $monthdate=  date("Y-m-d", strtotime("-12 month")); 
$crrntdte=date("Y-m-d");
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color:antiquewhite;">Last 30day's Expenses</h4>
